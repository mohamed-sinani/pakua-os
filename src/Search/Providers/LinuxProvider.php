        ...
        'ubuntu' => [
            ...
            'versions' => [
                ...
                '22.04.5 LTS "Jammy Jellyfish"' => [
                    ...
                    'verified' => true,
                    'fallback_urls' => [
                        'https://mirror.math.princeton.edu/pub/ubuntu-releases/22.04/ubuntu-22.04.5-desktop-amd64.iso',
                        'https://mirrors.mit.edu/ubuntu-releases/22.04/ubuntu-22.04.5-desktop-amd64.iso',
                    ],
                ],
            ],
        ],
        'debian' => [
            ...
            'versions' => [
                'Debian 12 "Bookworm"' => [
                    ...
                    'source' => 'Official Debian',
                    'verified' => true,
                    'fallback_urls' => [
                        'https://mirrors.mit.edu/debian-cd/current/amd64/iso-cd/debian-12.11.0-amd64-netinst.iso',
                        'https://mirror.cs.uchicago.edu/debian-cd/current/amd64/iso-cd/debian-12.11.0-amd64-netinst.iso',
                        'https://ftp.us.debian.org/debian-cd/current/amd64/iso-cd/debian-12.11.0-amd64-netinst.iso',
                    ],
                ],
            ],
        ],
        'fedora' => [
            ...
            'versions' => [
                'Fedora 42 Workstation' => [
                    ...
                    'source' => 'Official Fedora',
                    'verified' => true,
                    'fallback_urls' => [
                        'https://mirror.us-midwest-1.nexcess.net/fedora/linux/releases/42/Workstation/x86_64/iso/Fedora-Workstation-x86_64-42.iso',
                        'https://mirrors.mit.edu/fedora/linux/releases/42/Workstation/x86_64/iso/Fedora-Workstation-x86_64-42.iso',
                    ],
                ],
                'Fedora 41 Workstation' => [
                    ...
                    'verified' => true,
                    'fallback_urls' => [
                        'https://mirrors.mit.edu/fedora/linux/releases/41/Workstation/x86_64/iso/Fedora-Workstation-x86_64-41.iso',
                    ],
                ],
            ],
        ],
        ...
        'kali' => [
            ...
            'versions' => [
                'Kali 2025.4' => [
                    ...
                    'source' => 'Official Kali',
                    'verified' => true,
                    'fallback_urls' => [
                        'https://mirror.us-midwest-1.nexcess.net/kali-images/kali-2025.4/kali-linux-2025.4-installer-amd64.iso',
        ...
        'mint' => [
            ...
            'versions' => [
                'Linux Mint 22.1 "Xia"' => [
                    ...
                    'source' => 'Official Linux Mint',
                    'verified' => true,
                    'fallback_urls' => [
                        'https://mirrors.mit.edu/linuxmint-cd/stable/22.1/linuxmint-22.1-cinnamon-64bit.iso',
                        'https://ftp.heanet.ie/pub/linuxmint-cd/stable/22.1/linuxmint-22.1-cinnamon-64bit.iso',
                    ],
                ],
            ],
        ],
        'opensuse' => [
            ...
            'versions' => [
                'openSUSE Leap 15.6' => [
                    ...
                    'source' => 'Official openSUSE',
                    'verified' => true,
                    'fallback_urls' => [
                        'https://mirror-us1.he.net/opensuse/distribution/leap/15.6/iso/openSUSE-Leap-15.6-DVD-x86_64-Media.iso',
                    ],
                ],
            ],
        ],
